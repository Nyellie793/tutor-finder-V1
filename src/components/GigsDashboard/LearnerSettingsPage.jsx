      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm">
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          ...
          <div className="flex space-x-4">
            ...
            <button className="bg-purple-400 text-white px-4 py-2 rounded-lg flex items-center">
        ...
        <div className="flex">
          ...
          <div className="w-1/3 p-6">
            ...
            <div className="bg-pink-50 p-4 rounded-lg mb-6 text-center">
              ...
              <button className="bg-purple-400 text-white px-4 py-2 rounded-lg w-full">
