...
const LoginScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] flex flex-col justify-center px-6 py-12 w-full">
      <div className="w-full sm:mx-auto sm:w-full sm:max-w-xl">
        ...
        <div className="mt-8 bg-white py-8 px-4 sm:shadow-md rounded-lg sm:px-10">
          {loginError && (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  {...register("remember")}
                  className="h-4 w-4 text-[#0097a7] focus:ring-[#87ceeb] border-gray-300 rounded"
                />
                <label
                  htmlFor="remember"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <button
                  type="button"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-[#f7f7f7]"
                >
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
